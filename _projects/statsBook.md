...
**[Read the book](https://kdhenderson.github.io/stats-notes-for-ds/) · [View on GitHub](https://github.com/kdhenderson/stats-notes-for-ds)**

### Contents

**Part 1: Statistical Foundations**
T-distributions, data screening and transformations, Type I/II error and power, ANOVA, multiple comparisons, simple and multiple linear regression, model selection and validation.

**Part 2: Applied Statistics**
Bias-variance tradeoff, bootstrap methods, classification, logistic regression, PCA, and clustering.
